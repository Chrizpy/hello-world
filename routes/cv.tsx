        ...
        <div class="grid grid-cols-4 m-5">
          ...
          <div class="mt-5 tablet:mt-0 col-span-4 tablet:col-span-3">
            <div>
              ...
              >
                I worked as an assistant to the teacher during labs in courses
                that leaned towards embedded programming. These labs were very
                low level since all assignments required students to write their
                code in assembly. Both the labs and the course in general were
                really great, as they provided a better sense of respect for the
                computer and a deeper understanding of how applications function
                in everyday life.
              </CvCard>
            </div>
            ...
            <div class="mt-5">
              ...
              >
                ...
                career in this field. To achieve this goal, I made the decision
                to attend university. After conducting thorough research and
                receiving a recommendation from a close friend, I chose to
                enroll at Linköping University. This educational journey was
                both exhilarating and challenging, as university studies proved
                to be more demanding than anything I had encountered before.
                However, this experience toughened me and equipped me with the
                necessary skills to become a competent employee, or so I
                believe.
              </CvCard>
              ...
              >
                In 2019, I participated in an Erasmus exchange program in
                Ireland. As part of the program, I had the opportunity to study
                at the University of Limerick. I spent three months living in
                Ireland on my own, and it turned out to be an incredibly
                enjoyable and transformative experience.
              </CvCard>
            </div>
          </div>
        </div>
